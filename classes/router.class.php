...
class router {
    ...
    public $pubPages;
    public $data = array();
    public static $blacklistItems = array('block','ip', 'port', 'url', 'sms', 'phone', 'app', 'process', 'file', 'permissions', 'activities', 'receivers');
    ...
    function __construct() {
        ...
        $this->blacklistItems = array('block','ip', 'port', 'url', 'sms', 'phone', 'app', 'process', 'file', 'permissions', 'activities', 'receivers');
